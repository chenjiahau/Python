...
const ContactTechnicalSupportMSP = () => {
        ...
        <Card>
          <Card.Body>
            ...
            <Container style={{ margin: 0, padding: 0 }} className='mb-5'>
              <div className={mainStyle['contact-container']}>
                <div>
                  <div className='form-group form-group--align-top'>
                    <div className='form-title form-title--small-width required'>Name</div>
                  ...
                  <div className='form-group form-group--align-top'>
                    <div className='form-title form-title--small-width required'>E-mail</div>
                    <div className='form-field'>
                      <Input
                        type='text'
                  ...
                  <div className='form-group form-group--align-top'>
                    <div className='form-title form-title--small-width required'>Phone</div>
                    <div className='form-field'>
                      <Input
                        type='number'
                  ...
                  <div className='form-group form-group--align-top'>
                    <div className='form-title form-title--small-width required'>Issue category</div>
                    <div className='form-field'>
                      <DropdownWithItem
                  ...
                  <div className='form-group form-group--align-top'>
                    <div className='form-title form-title--small-width required'>Device type</div>
                    <div className='form-field'>
                      <DropdownWithItem
                        id='issue-category-dropdown'
                        type='normal'
                  ...
                  <div className='form-group form-group--align-top'>
                    <div className='form-title form-title--small-width required'>Problem device</div>
                    <div className='form-field'>
                ...
                <div>
                  <div className='form-group' style={{ alignItems: 'flex-start' }}>
                    <div className='form-title form-title--small-width required'>Description</div>
                    <div className='form-field'>
                      <Textarea
                        style={{ height: 100 }}
                  ...
                  <div className='form-group form-group--align-top' style={{ alignItems: 'flex-start' }}>
                    <div className='form-title form-title--small-width '>Attachment</div>
...
export default ContactTechnicalSupportMSP;
