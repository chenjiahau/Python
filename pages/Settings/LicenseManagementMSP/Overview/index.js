    ...
    <div className={overviewStyle['top-overview-container']}>
      <Row>
        <Col className={overviewStyle['devices-status-container']}>
          ...
          <div className={overviewStyle['sub-status-container']}>
            <div>
              <img className='mx-3' src='../img/v2/icon/device_ap.png' width={65} />
            </div>
            <div className={overviewStyle['number-container']}>
          ...
          <div className={overviewStyle['sub-status-container']}>
            <div>
              <img className='mx-3' src="../img/v2/icon/device_switch.png" width={65} />
            </div>
            <div className={overviewStyle['number-container']}>
          ...
          <div className={overviewStyle['sub-status-container']}>
            <div>
              <img className='mx-3' src="../img/v2/icon/device_gateway.png" width={65} />
            </div>
            <div className={overviewStyle['number-container']}>
