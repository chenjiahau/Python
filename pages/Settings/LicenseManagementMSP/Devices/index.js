        ...
        <Col className={devicesStyle['devices-status-container']}>
          <div className={devicesStyle['sub-status-container']}>
            <div className={devicesStyle['number-container']}>
              ...
              <a href="#/" className={devicesStyle['number-count']}>
                1058
              </a>
            </div>
          </div>
    ...
    <div className={devicesModalStyle['inventory-add-device-modal']}>
      ...
      >
        ...
        <div className="body">
          ...
          <div
            className={`mb-1 ms-3 ${
              addDeviceMode === 'add' ? 'd-block' : 'd-none'
            }`}
          >
            <Row>
              <Col sm={6}>
              ...
              <Col sm={6}>
                <div className="modal-form-title required">Device UID #3</div>
                <div className={devicesModalStyle['add-device-input-group']}>
                  <Input
                    type="text"
                    value=''
          ...
          <div
            className={`mb-1 ms-3 ${
              addDeviceMode === 'bulk' ? 'd-block' : 'd-none'
            }`}
          >
            <div className={`mb-1 ${devicesModalStyle['bulk-import-hint']}`}>
              Upload a CSV-formatted file with device UID you wish to add to inventory.
            </div>
    ...
    <div className={devicesModalStyle['inventory-assign-to-modal']}>
      ...
      >
        ...
        <div className="body">
          ...
          <div
            className={`mb-1 ms-3 ${
              devicesModalStyle['existing-org-container']
            } ${assignToMode === 'existing' ? 'd-block' : 'd-none'}`}
          >
            <Row>
              <Col>
                <div className={devicesModalStyle['select-org-container']}>
                  ...
                  >
                    <div className={devicesModalStyle['more-org']}>
                      <div className={devicesModalStyle['show-more-info']}>
          ...
          <div
            className={`mb-1 ms-3 ${devicesModalStyle['new-org-container']} ${
              assignToMode === 'new' ? 'd-block' : 'd-none'
            } mt-1`}
          >
            <Row>
              <Col>
    ...
    <InlineTitle isNonUnderline>
      ...
      >
        ...
        <li className="mt-2">
          ...
          <div className={devicesStyle['advanced-select-org-container']}>
            <DropdownWithAdvancedSearch
              value={''}
              buttonIcon={'enter'}
              dataBsToggleOnInput={true}
              dataBsToggleOnButton={true}
              onChange={e => console.log(e.target.value)}
              subContainerOnClick={e => e.stopPropagation()}
            >
              <div className={devicesStyle['more-org']}>
                <div className={devicesStyle['show-more-info']}>
                  Showing first 10 of total 116 organizations.
                </div>
                <LinkerWithA
                  label="more"
        ...
        <li className="mt-2">
          <div className="form-title w-100">Serial number :</div>
          <InputWithIconButton
            type="search"
            placeholder="Search"
            autoComplete="msp-search"
