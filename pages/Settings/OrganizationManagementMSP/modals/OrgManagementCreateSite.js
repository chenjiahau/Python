...
const OrgManagementCreateSite = props => {
  ...
  return (
    <ModalContainer
      ...
      openModal={modalStatus.createSite.status}
      closeModal={() => changeModalStatus('createSite', false)}
    >
...
export default OrgManagementCreateSite;
