...
const OrgManagementCreateSiteTag = props => {
    ...
    <Row>
      ...
      <Col>
        ...
        <Col className='mb-2'>
          ...
          <div className='modal-form-title required short-block-margin'>Regional Manager's Name</div>
          <div className='modal-form-field'>
            <Input
  ...
  return (
    <ModalContainer
      ...
      openModal={modalStatus.createSiteTag.status}
      closeModal={() => changeModalStatus('createSiteTag', false)}
    >
      <div className='header'>
        <div className='title'>{t(modalStatus.createSiteTag.label)}</div>
      </div>
      ...
      <div className='footer'>
        <Button
          ...
          onClick={() => changeModalStatus('createSiteTag', false)}
        />
        <Button
          label='Save'
...
export default OrgManagementCreateSiteTag;
