...
import CoTermination from './CoTermination';
...
const LicenseManagement = () => {
  ...
  const defaultTabList = [
    ...
    { id: 4, breadCrumbLabel: 'License co-termination', label: 'CO-TERMINATION', value: 'cot-ermination', isActive: false },
    { id: 5, breadCrumbLabel: 'License logs', label: 'LICENSE LOGS', value: 'license-logs', isActive: false }
  ];
  ...
  return (
    <>
      ...
      {tabList[3].isActive && <CoTermination />}
      {tabList[4].isActive && <LicenseLog />}
    </>
  )
}
