...
const LicenseManagement = () => {
  ...
  const defaultTabList = [
    { id: 1, breadCrumbLabel: 'New Releases', label: 'NEW RELEASES', value: 'newReleases', isActive: true },
    { id: 2, breadCrumbLabel: 'Firmware Upgrades', label: 'FIRMWARE UPGRADES', value: 'firmwareUpgrades', isActive: false },
    { id: 3, breadCrumbLabel: 'Firmware Management', label: 'FIRMWARE MANAGEMENT', value: 'firmwareManagement', isActive: false },
  ];
