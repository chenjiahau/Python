...
const MostDHCPClientsModal = (props) => {
  ...
  return (
    <div className="">
      <ModalContainer
        ...
        openModal={modalStatus.mostDHCPClients.status}
        closeModal={() => changeModalStatus("mostDHCPClients", false)}
      >
...
export default MostDHCPClientsModal;
