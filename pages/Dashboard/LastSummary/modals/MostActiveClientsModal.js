...
const MostActiveClientsModal = (props) => {
  ...
  return (
    <div className="">
      <ModalContainer
        ...
        openModal={modalStatus.mostActiveClients.status}
        closeModal={() => changeModalStatus("mostActiveClients", false)}
      >
...
export default MostActiveClientsModal;
