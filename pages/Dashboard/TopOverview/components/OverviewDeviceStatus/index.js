...
const OverviewDeviceStatus = (props) => {
  ...
  return (
    <Col md={4}
      ...
      className={`${sortable !== true ? '' : dashboardStyle['sortable-container-layer2']}  ${topOverviewStyle['overview-device-status-container']}`}
...
export default OverviewDeviceStatus;
