...
const OfflineModal = props => {
  ...
  const fakeDeviceList = [
    { ...generateDevice('AP', 'DBA-1210P', 'AP0001', 'Offline'), lastSeen: '2023/05/08 05:26' },
    { ...generateDevice('SWITCH', 'DBS-2000', 'AP0001', 'Offline'), lastSeen: '2023/05/08 05:26' },
    { ...generateDevice('GATEWAY', 'DBG-2000', 'GW001', 'Offline'), lastSeen: '2023/05/08 05:26' }
  ];
  ...
  return (
    <div className=''>
      ...
      >
        ...
        <div className='body'>
          <OfflineTable deviceList={deviceList} setDeviceList={setDeviceList} />
