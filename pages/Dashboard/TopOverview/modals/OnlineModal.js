...
const OnlineModal = props => {
  ...
  const fakeDeviceList = [
    { ...generateDevice('AP', 'DBA-1210P', 'AP0001', 'Online'), lastSeen: '2023/05/08 05:26' },
    { ...generateDevice('SWITCH', 'DBS-2000', 'AP0001', 'Online'), lastSeen: '2023/05/08 05:26' },
    { ...generateDevice('GATEWAY', 'DBG-2000', 'GW001', 'Online'), lastSeen: '2023/05/08 05:26' },
    { ...generateDevice('GATEWAY', 'DBG-X1000', 'GW002', 'Online'), lastSeen: '2023/05/08 05:26' },
    { ...generateDevice('GATEWAY', 'DBG-2000(B1)', 'GW0003', 'Online'), lastSeen: '2023/05/08 05:26' },
    { ...generateDevice('GATEWAY', 'DBG-2000(B1)', 'GW0004', 'Online'), lastSeen: '2023/05/08 05:26' }
  ];
  ...
  return (
    <div className=''>
      ...
      >
        ...
        <div className='body'>
          <OnlineTable deviceList={deviceList} setDeviceList={setDeviceList} />
