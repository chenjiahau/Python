...
// Component
import {
  Button, Breadcrumb, InlineTitle, MessageBoxGroup, PaginationContainer,
  Icon, DropdownWithCheckbox, ButtonWithIcon, LinkerWithA, InputWithIcon,
  TimePickerSimply
} from 'components/';
...
const defaultDeviceList = [
  { title: '08:35:2C:8E:DA:48', checked: true }
];

const EventLog = () => {
  // Fake API data
  const fakerEventLogList = getEventLogList('AP');
  ...
  const DatePickerCustomInput = forwardRef(({ value, onClick, onChange }, ref) => (
    <button
      className={mainStyle['custom-input']}
      onClick={onClick}
      ref={ref}>
      <div className='d-flex justify-content-start'>
        ...
        <div className={`${mainStyle['custom-text']}`}>
          {value}
        </div>
      </div>
    </button>
      ...
      <div className="layout-container layout-container--column layout-container--fluid">
        ...
        <div className={mainStyle['filter-container']}>
          ...
          <div className={mainStyle['item-group']}>
            <div className={mainStyle['item-title']}>
              Start date
            </div>
            <div className={mainStyle['item-field']}>
              <div
                className={mainStyle['data-picker-container']}
                style={{ zIndex: 2 }}
              >
                <DatePicker
        ...
        <div className={mainStyle['button-container']}>
          ...
          <Button
            label="Filter"
            className={`btn-indigo ${mainStyle['button']}`}
            onClick={() => { }}
          />
          <ButtonWithIcon
            label="Download"
            ...
            <tr>
              ...
              <th>
                <LinkerWithA
                  ...
                  onClick={e => sorting(e, eventLogList, 'time', setEventLogList)}
                />
              </th>
              <th>
                <LinkerWithA
                  label="Access point"
                  className="text-decoration-none"
                  onClick={e => sorting(e, eventLogList, 'device', setEventLogList)}
                />
              </th>
              <th>
                <LinkerWithA
                  label="Site"
                  className="text-decoration-none"
                  onClick={e => sorting(e, eventLogList, 'site', setEventLogList)}
                />
              </th>
              <th>
                <LinkerWithA
                  label="MAC address"
                  className="text-decoration-none"
                  onClick={e => sorting(e, eventLogList, 'macAddress', setEventLogList)}
                />
              </th>
              <th>
                <LinkerWithA
                  label="Severity"
                  className="text-decoration-none"
                  onClick={e => sorting(e, eventLogList, 'severity', setEventLogList)}
                />
              </th>
              <th>
                <LinkerWithA
                  label="SSID"
                  className="text-decoration-none"
                  onClick={e => sorting(e, eventLogList, 'ssid', setEventLogList)}
                />
              </th>
              <th>
                <LinkerWithA
                  label="Client"
                  className="text-decoration-none"
                  onClick={e => sorting(e, eventLogList, 'client', setEventLogList)}
                />
              </th>
              <th>
                <LinkerWithA
                  label="Event type"
                  className="text-decoration-none"
                  onClick={e => sorting(e, eventLogList, 'eventType', setEventLogList)}
                />
              </th>
              <th>
                <LinkerWithA
                  ...
                  className="text-decoration-none"
                  onClick={e => sorting(e, eventLogList, 'eventDescription', setEventLogList)}
                />
              </th>
            </tr>
          </thead>
