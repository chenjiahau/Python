...
const Profiles = () => {
  ...
  const fakerProfileList = generateProfileList('AP', 10, true);
                  ...
                  <tr key={`profile-table-td-check-${index}`}>
                    ...
                    <td className='table-action-td'>
                      <ButtonAction
                        label='SSID'
                        title='SSID'
                        iconClassName='icon-ssid'
                        onClick={() => navigate(`/cloud/configure/access-point/profile/${profile.id}?tab=ssid`)}
                      />
                      <ButtonAction
                        label='RADIO'
                        title='RADIO'
                        iconClassName='icon-radio'
                        onClick={() => navigate(`/cloud/configure/access-point/profile/${profile.id}?tab=radio`)}
                      />
                      <ButtonAction
                        label='SETTINGS'
                        title='SETTINGS'
                        iconClassName='icon-settings'
                        onClick={() => navigate(`/cloud/configure/access-point/profile/${profile.id}?tab=settings`)}
                      />
                    </td>
                  </tr>
                )
