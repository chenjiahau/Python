...
import EditWalledGardenModal from 'cloudUi/Modals/WalledGardenModal/EditWalledGarednModal';
          ...
          return <tr key={item.id}>
            ...
            <td className={'table-action-td'}>
              <ButtonAction
                ...
                onClick={() => props.changeModalStatus('editWalledGarden', true)}
              />
              <ButtonAction
    ...
    <div className='layout-container layout-container--column layout-container--fluid'>
      ...
      <div className='d-flex justify-content-between mb-2'>
        <ButtonGroup>
          <Button
            label={t('14df9b075b')}
            onClick={() => changeModalStatus('addWalledGarden', true)}
          ></Button>
        </ButtonGroup>
