...
const AddIgmpSnoopingVlanModal = props => {
  ...
  return (
    <ModalContainer
      ...
      openModal={modalStatus.addIgmpSnoopingVlan.status}
      closeModal={() => changeModalStatus(modalStatus.addIgmpSnoopingVlan.self, false)}
    >
      <div className='header'>
        <div className='title'>Add IGMP snooping VLAN settings</div>
      </div>
      <div className='body'>
        <MessageBoxGroup
          messages={messages}
      ...
      <div className='footer'>
        <Button
          ...
          onClick={() => {
            changeModalStatus(modalStatus.addIgmpSnoopingVlan.self, false);
          }}
        />
        <Button
          label='Add'
...
export default AddIgmpSnoopingVlanModal;
