...
// Component
import { Button, ModalContainer, DropdownWithItem, Input } from 'components/';
...
const MirrorPortModal = props => {
  ...
  useEffect(() => {
    ...
    setPortGroup(selectedPortList[0].portGroup);
  }, [selectedPortList]);
    ...
    >
      ...
      <div className={`body ${mainStyle['mirror-port-modal-body']}`}>
        <div className='form-group'>
          <div className={`form-title short-block-margin ${mainStyle['form-title']}`}>Switch ports group:</div>
