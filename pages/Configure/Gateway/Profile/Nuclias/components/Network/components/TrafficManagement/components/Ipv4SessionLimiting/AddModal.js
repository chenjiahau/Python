...
// Dummy data & util
import { getIpv4SessionLimitingConfig } from 'dummy/data/gateway/data/network/traffic-management/ipv4-session-limiting';
...
const AddModal = props => {
  ...
  useEffect(() => {
    ...
    const sessionLimitingConfig = getIpv4SessionLimitingConfig();
