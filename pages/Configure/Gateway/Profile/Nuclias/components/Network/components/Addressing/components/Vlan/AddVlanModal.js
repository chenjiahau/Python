...
const AddVlanModal = props => {
  ...
  return (
    <ModalContainer
      ...
      openModal={modalStatus.addVlan.status}
      closeModal={() => changeModalStatus(modalStatus.addVlan.self, false)}
    >
      <div className='header'>
        <div className='title'>Add VLAN profile</div>
      </div>
      <div className='body'>
        {/* Name, Untagged ports */}
        <Row>
      ...
      <div className='footer'>
        <Button
          ...
          onClick={() => changeModalStatus(modalStatus.addVlan.self, false)}
        />
        <Button
          label='Save'
