...
const Ipv6TrafficShaping = () => {
  ...
  useEffect(() => {
    ...
    const updatedList = cloneDeep(trafficManagementState.ipv6TrafficShaping);
    setList(cloneDeep(updatedList));
    setProfileList(cloneDeep(updatedList));
  }, [trafficManagementState.ipv6TrafficShaping]);
  ...
  return (
    <>
      <Func title='IPV6 TRAFFIC SHAPING'>
        <div className='mb-2'>
          <div className='justify-content-between d-flex'>
            ...
            <InlineTitle isNonUnderline>
              ...
              <DropdownWithCheckbox
                id='ipv6-traffic-shaping-field-dropdown'
                type='checkbox'
...
export default Ipv6TrafficShaping;