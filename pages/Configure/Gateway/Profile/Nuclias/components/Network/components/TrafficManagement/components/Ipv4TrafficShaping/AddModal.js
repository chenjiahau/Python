...
// Dummy data & util
import { getIpv4TrafficShapingConfig } from 'dummy/data/gateway/data/network/traffic-management/ipv4-traffic-shaping';
...
const AddModal = props => {
  ...
  useEffect(() => {
    ...
    const trafficShapingConfig = getIpv4TrafficShapingConfig();
