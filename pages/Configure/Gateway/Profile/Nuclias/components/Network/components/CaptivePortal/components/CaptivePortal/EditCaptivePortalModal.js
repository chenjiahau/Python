...
const EditCaptivePortalModal = props => {
  const {
    modalStatus,
    changeModalStatus,
    addCommonPool,
  ...
  return (
    <ModalContainer
      ...
      openModal={modalStatus.editCp.status}
      closeModal={() => changeModalStatus(modalStatus.editCp.self, false)}
    >
      <div className='header'>
        <div className='title'>Edit captive portal</div>
      </div>
      <div className='body'>
        {/* Name */}
                      ...
                      >
                        ...
                        <div>
                          <Button
                            ...
                            onClick={() => addCommonPool('editCp', 'addLocalDb')}
                          />
                        </div>
                        <div>
                              ...
                              <>
                                ...
                                <div>
                                  <Button
                                    ...
                                    className='btn-grey-blue'
                                    onClick={() => addCommonPool('editCp', 'addRadius')}
                                  />
                                </div>
                                <div>
                              ...
                              <>
                                ...
                                <div>
                                  <Button
                                    ...
                                    className='btn-grey-blue'
                                    onClick={() => addCommonPool('editCp', 'addLdap')}
                                  />
                                </div>
                                <div>
                ...
                >
                  ...
                  <div>
                    <Button
                      ...
                      className='btn-grey-blue'
                      onClick={() => addCommonPool('editCp', 'addSms')}
                    />
                  </div>
                  <div>
                ...
                >
                  ...
                  <div>
                    <Button
                      ...
                      className='btn-grey-blue'
                      onClick={() => addCommonPool('editCp', 'addWalledGarden')}
                    />
                  </div>
                  <div>
      ...
      <div className='footer'>
        <Button
          ...
          onClick={() => changeModalStatus(modalStatus.editCp.self, false)}
        />
        <Button
          label='Save'
...
export default EditCaptivePortalModal;
