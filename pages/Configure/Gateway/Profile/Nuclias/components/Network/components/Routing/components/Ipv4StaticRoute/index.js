...
const Ipv4StaticRoute = () => {
  ...
  useEffect(() => {
    ...
    const updatedList = cloneDeep(routingState.ipv4StaticRoute);
    setList(cloneDeep(updatedList));
    setProfileList(cloneDeep(updatedList));
  }, [routingState.ipv4StaticRoute]);
              ...
              <tr>
                ...
                <th>
                  <LinkerWithA
                    ...
                    className='text-decoration-none'
                    onClick={e => {
                      isUseProfileConfig && sorting(e, profileList, 'subnetMask', setProfileList);
                      !isUseProfileConfig && sorting(e, list, 'subnetMask', setList);
                    }}
                  />
                </th>
                <th>
                          ...
                          !isUseProfileConfig ? (
                            <>
                              <div className='d-flex'>
                                <RadioButton
                                  id={`ipv4-static-route-active-${index}-enable`}
                                  name={`ipv4StaticRouteActive${index}`}
                                  label='Enable'
                                  hasRightMargin={true}
                                  checked={item.active}
                                ...
                                />
                                <RadioButton
                                  id={`ipv4-static-route-active-${index}-disable`}
                                  name={`ipv4StaticRouteActive${index}`}
                                  label='Disable'
                                  checked={!item.active}
...
export default Ipv4StaticRoute;