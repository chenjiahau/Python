...
const AddIpModal = props => {
  ...
  return (
    <ModalContainer
      ...
      openModal={modalStatus.addIp.status}
      closeModal={() => changeModalStatus(modalStatus.addIp.self, false)}
    >
      <div className='header'>
        <div className='title'>Add IP management configuration</div>
      </div>
      <div className='body'>
        {/* Name, Interface */}
        <Row className='mt-2'>
      ...
      <div className='footer'>
        <Button
          ...
          onClick={() => changeModalStatus(modalStatus.addIp.self, false)}
        />
        <Button
          label='Save'
