...
const Ipv4PolicyRoute = () => {
  ...
  useEffect(() => {
    ...
    const updatedList = cloneDeep(routingState.ipv4PolicyRoute);
    setList(cloneDeep(updatedList));
    setProfileList(cloneDeep(updatedList));
  }, [routingState.ipv4PolicyRoute]);
                          ...
                          !isUseProfileConfig ? (
                            <>
                              <div className='d-flex'>
                                <RadioButton
                                  id={`ipv4-policy-active-${index}-enable`}
                                  name={`ipv4PolicyRouteActive${index}`}
                                  label='Enable'
                                  hasRightMargin={true}
                                  checked={item.active}
                                ...
                                />
                                <RadioButton
                                  id={`ipv4-policy-active-${index}-disable`}
                                  name={`ipv4PolicyRouteActive${index}`}
                                  label='Disable'
                                  checked={!item.active}
...
export default Ipv4PolicyRoute;