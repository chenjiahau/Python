...
const Ipv6SessionLimit = () => {
  ...
  useEffect(() => {
    ...
    const updatedList = cloneDeep(trafficManagementState.ipv6SessionLimiting);
    setList(cloneDeep(updatedList));
    setProfileList(cloneDeep(updatedList));
  }, [trafficManagementState.ipv6SessionLimiting]);
...
export default Ipv6SessionLimit;