...
const AddDynamicDnsModal = props => {
  const {
    modalStatus,
    changeModalStatus,
    interfaces,
  ...
  useEffect(() => {
    ...
    serverProviderDropdown[0].isActive = true;
    ...
    ipAddressTypeDropdown[0].isActive = true;
    updatedForm.ipAddressType = ipAddressTypeDropdown;

    setForm(updatedForm);
  }, [modalStatus.addDDns.status]);
  ...
  return (
    <ModalContainer
      ...
      openModal={modalStatus.addDDns.status}
      closeModal={() => changeModalStatus(modalStatus.addDDns.self, false)}
    >
      <div className='header'>
        <div className='title'>Add DDNS</div>
      </div>
      <div className='body'>
        {/* Service provider */}
        <Row>
      ...
      <div className='footer'>
        <Button
          ...
          onClick={() => changeModalStatus(modalStatus.addDDns.self, false)}
        />
        <Button
          label='Save'
...
export default AddDynamicDnsModal;
