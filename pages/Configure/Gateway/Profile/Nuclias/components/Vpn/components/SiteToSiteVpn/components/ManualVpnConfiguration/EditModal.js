...
import { getEditManualVpnConfiguration } from 'dummy/data/gateway/data/vpn/site-to-site-vpn/manual-vpn-configuration';
...
const EditModal = ({
  ...
  useEffect(() => {
    const tmpConfig = getEditManualVpnConfiguration(selectedConfig);
    setConfig(tmpConfig);
  }, [selectedConfig])
  ...
  return (
    <ModalContainer
      ...
      closeModal={() => changeModalStatus('editConfig', false)}
    >
      <div className='header'>
        <div className='title'>Edit manual VPN configuration</div>
      </div>
      <div className='body'>
      ...
      <div className='footer'>
        <Button
          ...
          onClick={() => changeModalStatus('editConfig', false)}
        />
        <Button
          label='Save'
