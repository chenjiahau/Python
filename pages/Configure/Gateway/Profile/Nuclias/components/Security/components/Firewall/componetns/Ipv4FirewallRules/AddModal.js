...
// Dummy data & util
import { getIpv4FirewallRuleConfig } from 'dummy/data/gateway/data/security/firewall/ipv4-firewall-rules';
...
const AddModal = props => {
  ...
  useEffect(() => {
    ...
    const ipv4FirewallRuleConfig = getIpv4FirewallRuleConfig();
  ...
  return (
    ...
    >
      <div className='header'>
        <div className='title'>Add IPv4 firewall rules</div>
      </div>
      <div className='body'>
        {/* Priority, Name*/}
        <Row className='mt-2'>
